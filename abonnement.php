    ...
    <div style="display:flex">
        ...
        <div class="divform">
            <form method='POST' action="">
                ...
                <div class="inputs">
                    <p style="margin:auto;text-align:center;font-family:roboto;padding:15px;font-size:19px">Votre compte
                        vous donne 10% sur tous nos produit et coûte 5$ par moi.<br><br>Vous devez avoir un compte.</p>
